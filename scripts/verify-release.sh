...
grep -qx 'assets/private-backends-NOTICE.txt' <<<"$contents"
grep -qx 'assets/private-backends/tgcli.zip' <<<"$contents"
grep -qx 'assets/private-backends/officecli/officecli' <<<"$contents"
grep -qx 'assets/private-backends/tessdata/eng.traineddata' <<<"$contents"
grep -qx 'assets/private-backends/licenses/mupdf-COPYING.txt' <<<"$contents"
grep -qx 'assets/private-backends/licenses/officecli-LICENSE.txt' <<<"$contents"
grep -qx 'assets/private-backends/licenses/tgcli-LICENSE.txt' <<<"$contents"
grep -qx 'assets/codex/plugins/codex-mobile/marketplace.json' <<<"$contents"
grep -qx 'assets/codex/plugins/codex-mobile/plugins/documents/.codex-plugin/plugin.json' <<<"$contents"
grep -qx 'assets/codex/plugins/codex-mobile/plugins/documents/skills/documents/SKILL.md' <<<"$contents"
grep -qx 'assets/codex/plugins/codex-mobile/plugins/telegram/.codex-plugin/plugin.json' <<<"$contents"
grep -qx 'assets/codex/plugins/codex-mobile/plugins/telegram/skills/telegram/SKILL.md' <<<"$contents"
