...
grep -q 'app-server-client = "0.145.0-1"' gradle/libs.versions.toml
...
grep -q 'documents-provider = "1.0.0"' gradle/libs.versions.toml
grep -q 'telegram-provider = "1.0.0"' gradle/libs.versions.toml
grep -q 'enum class ProviderDelivery { BUNDLED, LEGACY_SPLIT }' \
  platform/android/src/main/kotlin/io/github/ciurlaro/codexmobile/platform/android/ProviderModels.kt
grep -q 'BUNDLED_PROVIDER_FACTORIES' \
  platform/android/src/main/kotlin/io/github/ciurlaro/codexmobile/platform/android/InstalledProviderStore.kt
...
grep -q 'CANONICAL_PROVIDER_REPOSITORY = "ciurlaro/codex-mobile-plugins"' platform/android/src/main/kotlin/io/github/ciurlaro/codexmobile/platform/android/ProviderSourcePolicy.kt
...
rg -q 'AppServerClientMethods.MarketplaceAdd' agent/codex/src/main
rg -q 'AppServerClientMethods.ThreadInjectItems' agent/codex/src/main
rg -q 'AppServerClientMethods.TurnSteer' agent/codex/src/main
rg -q 'mcp_servers\.' agent/codex/src/main
