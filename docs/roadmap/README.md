...
| Step | Outcome | Status |
|---|---|---|
| [01](01-runtime-premise.md) | Bundled Codex authenticates and streams in a visible Activity | Not started |
| [02](02-read-only-authority.md) | Codex reads only a user-selected SAF scope | Blocked by 01 |
