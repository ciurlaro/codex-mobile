...
class Step02ReadOnlyAuthorityTest {
    @Test
    fun grantSelectionPersistenceRevocationAndIdentity() =
        TODO("S02-GRANT-01 through S02-GRANT-05")

    @Test
    fun directoryListingHandlesNamesScaleAndProviderAnomalies() =
        TODO("S02-LIST-01 through S02-LIST-04")

    @Test
    fun boundedReadsHandleContentAndStreamFailures() =
        TODO("S02-READ-01 through S02-READ-04")

    @Test
    fun scopeConfinementRejectsForeignPathsAndRedirectedIdentifiers() =
        TODO("S02-SCOPE-01, S02-SCOPE-02")

    @Test
    fun toolValidationDefaultsToDenyAndReturnsAndroidTruth() =
        TODO("S02-TOOL-01 through S02-TOOL-04")

    @Test
    fun providerLifecycleAndLoggingRemainSafe() =
