...
fun String.normalizeMathMarkdown(): String {
...
fun decodeMathLink(link: String): String? = link
...
private fun appendInlineMath(out: StringBuilder, formula: String) {
    val encoded = Base64.UrlSafe.encode(formula.trim().encodeToByteArray()).trimEnd('=')
