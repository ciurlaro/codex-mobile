...
internal data class PendingBuiltInApproval(
    ...
    val permit: AtomicBoolean = AtomicBoolean(false),
    val dispatch: AtomicBoolean = AtomicBoolean(false),
)
...
internal data class PendingAvailabilityNotice(
    val text: String,
    val availability: Map<String, Boolean>,
)

internal data class MarketplaceSource(
...
internal const val AVAILABILITY_MESSAGE_PREFIX = "codex-mobile:plugin-availability"
